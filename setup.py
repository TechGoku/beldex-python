...
version = find_version("beldex", "__init__.py")

setup(
    name="beldex",
    version=version,
    description="A comprehensive Python module for handling Beldex cryptocurrency",
    url="https://github.com/TechGoku/beldex-python.git",
    ...
    keywords="beldex cryptocurrency",
    test_suite="tests",
)
